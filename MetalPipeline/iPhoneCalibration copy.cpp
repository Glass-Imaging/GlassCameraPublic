        ...
        std::array<DenoiseParameters, 5> denoiseParameters = {{
            {
                ...
                .gradientBoost = 0, // 2 * (2 - smoothstep(0.7, 1.0, nlf_alpha)),
            ...
            },
            {
                ...
                .chromaBoost = chromaBoost,
                .gradientBoost = 0, // (2 - smoothstep(0.7, 1.0, nlf_alpha)),
                .sharpening = 1.1
            },
            {
                .luma = lmult[2] * lerp,
