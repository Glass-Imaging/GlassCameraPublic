...
*/
float get_affine_std(float mu_c, float std_c, float mu_e, float std_e, float mu);
...
*/
void filter_curve(float* mus_c, float* stds_c, int num_bins, float* new_std_control, int D, bool allow_up);
